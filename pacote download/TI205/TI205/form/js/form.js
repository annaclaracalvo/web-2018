...
function validaCPF(strCPF) {
      ...
      /*
         ...
         substring(início,fim)- retira caracteres de uma string começando pelo caracter 
            ...
            retirado por esse método
             substr pegava (0,1) sendo 1 o numero de caracteres que ele pega, 
             ja o substring pega somente o 0, levando em conta o exemplo
      */
      Soma =0;
      for (i=1; i<=9; i++)
      ...
      Resto = (Soma*10)%11;
      if (Resto > 9) Resto =0;
      /* Se o resto for diferente do preimeiro digito verificador, erro
      */
  ...
  */
  ...
  if (Resto!=parseInt(strCPF.substring(10,11)))
  	return false;
  /*
   Se não hpuver erro, return truekkr
  */
