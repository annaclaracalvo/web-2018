	...
	*/
	...
	$(document).ready(function(){
		...
		*/
		...
		/*
			Executa incEnd2.php por AJAX e exibe resposta por janela modal
		*/
			...
			if (validarDados()){
				...
				$.ajax({
					...
					success: function(resposta){
						/*
						Se existir a palavra "Erro" na resposta, exibir janela modal de erro. senão, janela modal de sucesso
						*/
						if (resposta.indexOf("Erro")!=-1){
							...
							$("#modalTextoTitulo").html("Inclusão bem sucedida");
